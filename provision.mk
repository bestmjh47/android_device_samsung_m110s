...
$(call inherit-product, vendor/provision/config/gsm.mk)

# Release name
PRODUCT_RELEASE_NAME := GalaxyS

# Inherit some common CM stuff.
$(call inherit-product, vendor/provision/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/samsung/m110s/full_galaxysmtd.mk)

## Device identifier. This must come after all inclusions
PRODUCT_DEVICE := galaxysmtd
PRODUCT_NAME := provision_galaxysmtd
